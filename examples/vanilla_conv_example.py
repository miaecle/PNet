...
Example script using saved vanilla-conv model to predict targets in CASP11, CASP12, CAMEO.
...
model_dir = os.path.join(os.environ['PNET_DATA_DIR'], '../saved_models/VanillaConv/')
model = pnet.models.VanillaConvContactMap(
